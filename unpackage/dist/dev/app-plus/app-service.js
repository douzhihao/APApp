...
"use strict";
eval("/* WEBPACK VAR INJECTION */(function(__f__) {\n\nvar _interopRequireDefault = __webpack_require__(/*! @babel/runtime/helpers/interopRequireDefault */ 2);\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.default = void 0;\nvar _ws = __webpack_require__(/*! ../../Utils/ws.js */ 42);\nvar _axios = _interopRequireDefault(__webpack_require__(/*! axios */ 43));\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n\nvar recorderManager = uni.getRecorderManager();\nvar _default = {\n  data: function data() {\n    return {\n      clientX: 0,\n      clientY: 0,\n      recording: false,\n      //在录音中\n      cancelRecord: false,\n      //取消录制\n      recordStatus: 0,\n      //录音状态 0=默认 1=录音中 2=上滑取消录音\n      userMsg: '',\n      //\n      robotMsg: '',\n      //\n      robotMsgList: [],\n      tipsPoint: false,\n      socketOpen: false,\n      recorder: null,\n      innerAudioContext: '',\n      showUserPart: false,\n      showRobotPart: false,\n      isLangTap: false,\n      isThinking: false,\n      isAsring: false,\n      // WSSUrl:'wss://i7u3629729.goho.co',\n      // WSSUrl:'wss://i25817465a.imdo.co',\n      // WSSUrl:'wss://yjwpv79rnsupshsh3.neiwangyun.net',\n      // WSSUrl:'ws://10.10.10.247:3000',\n      WSSUrl: 'ws://192.168.0.250:3000',\n      // WSSUrl:'wss://i25817465a.imdo.co',\n      // WSSUrl:'wss://54774dq657.zicp.fun',\n\n      options: {\n        duration: 60000,\n        sampleRate: 16000,\n        format: \"mp3\"\n      },\n      language: true,\n      // langugeType:'recognition'\n      langugeType: 'en-US'\n    };\n  },\n  onLoad: function onLoad() {\n    var that = this;\n    uni.getStorage({\n      key: 'WSSURL',\n      success: function success(res) {\n        __f__(\"log\", res, \" at pages/index/index.vue:198\");\n        that.WSSUrl = res.data;\n      },\n      fail: function fail(res) {\n        __f__(\"log\", res, \" at pages/index/index.vue:202\");\n      }\n    });\n    // try {\n    // \tconst res = uni.getStorageInfoSync();\n    // \tconsole.log(res.keys);\n    // \tconsole.log(res.currentSize);\n    // \tconsole.log(res.limitSize);\n    // } catch (e) {\n    // \t// error\n    // \tconsole.log(\"load没取到？\")\n    // }\n    // try {\n    // \tconst value = uni.getStorageSync('WSSURL');\n    // \tif (value) {\n    // \t\tconsole.log(value);\n    // \t\tthat.WSSUrl = WSSURL;\n    // \t}else{\n    // \t\tconsole.log(\"未连接其他WS\",value);\n    // \t\tuni.setStorageSync('WSSURL', that.WSSURL);\n    // \t}\n    // } catch (e) {\n    // \t// error\n    // \tuni.setStorageSync('WSSURL', that.WSSURL);\n    // \tconsole.log(\"本地未存储WS  使用默认WS\");\n    // }\n  },\n  mounted: function mounted() {\n    var that = this;\n    that.innerAudioContext = uni.createInnerAudioContext();\n    that.innerAudioContext.autoplay = true;\n    // this.innerAudioContext.src = 'https://bjetxgzv.cdn.bspapp.com/VKCEYUGU-hello-uniapp/2cc220e0-c27a-11ea-9dfb-6da8e309e0d8.mp3';\n    that.innerAudioContext.onPlay(function () {\n      __f__(\"log\", '开始播放', \" at pages/index/index.vue:237\");\n    });\n    that.innerAudioContext.onError(function (res) {\n      __f__(\"log\", res.errMsg, \" at pages/index/index.vue:240\");\n      __f__(\"log\", res.errCode, \" at pages/index/index.vue:241\");\n    });\n    that.recorder = uni.getRecorderManager();\n    that.recorder.onStop(function (res) {\n      // console.log('recorder stop' + JSON.stringify(res.tempFilePath));\n      that.Path = res.tempFilePath;\n      // console.log(that.Path,that.langugeType)\n      // console.log(res.tempFilePath);\n      uni.saveFile({\n        tempFilePath: that.Path,\n        success: function success(res) {\n          // console.log(res.savedFilePath);\n          var savedFilePath = res.savedFilePath;\n          __f__(\"log\", savedFilePath, that.langugeType, \" at pages/index/index.vue:256\");\n          uni.uploadFile({\n            url: \"https://share-test.metazen-tech.com/meta-tts/speech/recognitionMp3\",\n            // url: \"https://aigc.metazen-tech.com/meta-tts/speech/recognitionMp3\",  \n            // url: \"http://10.10.110.245:8058/tts/speech/recognitionMp3\",  \n            // filePath: that.Path,\n            filePath: savedFilePath,\n            timeout: 60000,\n            formData: {\n              // \"language\": \"zh-CN\"\n              \"language\": that.langugeType\n            },\n            name: 'multipartFile',\n            success: function success(res) {\n              var _data = JSON.parse(res.data);\n              __f__(\"log\", _data, _data.data, _data.data.length, _data.data !== \"\", \" at pages/index/index.vue:271\");\n              if (_data.data || _data.data.length > 0 || _data.data !== \"\") {\n                that.userMsg = _data.data;\n                that.showUserPart = true;\n                that.isAsring = true;\n                that.showRobotPart = true;\n                that.isThinking = true;\n                // console.log(that.userMsg,JSON.parse(res.data),\"----------\");\n                that.sendSocketMessage(JSON.stringify({\n                  ask: _data.data\n                }));\n              } else {\n                that.showUserPart = false;\n                that.isAsring = false;\n                uni.showToast({\n                  title: '未采集到声音',\n                  icon: 'error',\n                  duration: 2000\n                });\n              }\n            },\n            fail: function fail(res) {\n              __f__(\"log\", res, \" at pages/index/index.vue:291\");\n            }\n          });\n        }\n      });\n    });\n    // 创建 WebSocket 连接\n    uni.connectSocket({\n      url: that.WSSUrl\n    });\n    // 监听 WebSocket 打开\n    uni.onSocketOpen(function (res) {\n      __f__(\"log\", 'WebSocket连接已打开！---------------', \" at pages/index/index.vue:304\");\n      that.tipsPoint = true;\n      that.socketOpen = true;\n      var socktTimer = setInterval(function () {\n        __f__(\"log\", 'ping', \" at pages/index/index.vue:308\");\n        that.sendSocketMessage(JSON.stringify({\n          talk_data: 'ping'\n        }));\n      }, 10000);\n    });\n    // 监听 WebSocket 错误\n    uni.onSocketError(function (res) {\n      __f__(\"log\", 'WebSocket连接打开失败，请检查！--------------', \" at pages/index/index.vue:314\");\n      that.tipsPoint = false;\n      that.socketOpen = false;\n    });\n\n    // 发送 WebSocket 消息\n    // uni.sendSocketMessage(function(){\n\n    // })\n    // 接受 WebSocket 消息\n    uni.onSocketMessage(function (res) {\n      __f__(\"log\", '收到服务器内容：' + res.data, \" at pages/index/index.vue:325\");\n      var _msg = JSON.parse(res.data);\n      if (_msg.answer) {\n        __f__(\"log\", _msg.answer, \" at pages/index/index.vue:328\");\n        that.showRobotPart = true;\n        that.isThinking = false;\n        // that.robotMsg = that.robotMsg + _msg.answer ;\n\n        // let rich_text = \"<div>\"+_msg.answer+\"</div>\"\n        // that.robotMsgList = that.robotMsgList+rich_text;\n\n        var answerList = new Array();\n        answerList.unshift(_msg.answer);\n        that.robotMsgList = that.robotMsgList.concat(answerList);\n      }\n    });\n  },\n  beforeDestroy: function beforeDestroy() {\n    // closeWebsocketPotassium();\n\n    // 监听 WebSocket 关闭\n    uni.onSocketClose(function () {\n      that.tipsPoint = false;\n    });\n  },\n  methods: {\n    clickShowPopupWSS: function clickShowPopupWSS() {\n      this.$refs.popupWSS.open();\n    },\n    clickHidePopupWSS: function clickHidePopupWSS() {\n      this.$refs.popupWSS.close();\n      uni.clearStorage();\n    },\n    inputWSS: function inputWSS(e) {\n      // console.log(e.detail.value);\n      this.WSSUrl = e.detail.value;\n    },\n    disconnectWSS: function disconnectWSS() {\n      var that = this;\n      setTimeout(function () {\n        that.tipsPoint = false;\n      }, 1000);\n      // closeWebsocketPotassium();\n      // 监听 WebSocket 关闭\n      uni.closeSocket({\n        success: function success(res) {\n          that.tipsPoint = false;\n        }\n      });\n    },\n    connectWSS: function connectWSS() {\n      var that = this;\n      if (that.WSSUrl.length > 0 && that.WSSUrl != \"\") {\n        // closeWebsocketPotassium();\n        //  WebSocket 关闭\n        uni.closeSocket({\n          success: function success(res) {\n            __f__(\"log\", \"closeSocket\", res, \" at pages/index/index.vue:384\");\n            that.tipsPoint = false;\n            uni.connectSocket({\n              url: that.WSSUrl,\n              success: function success(res) {\n                that.tipsPoint = true;\n                __f__(\"log\", \"connectSocket\", res, \" at pages/index/index.vue:391\");\n                uni.setStorage({\n                  key: 'WSSURL',\n                  data: that.WSSUrl,\n                  success: function success(res) {\n                    __f__(\"log\", 'success', res, \" at pages/index/index.vue:396\");\n                  },\n                  fail: function fail() {\n                    __f__(\"log\", 'fail', res, \" at pages/index/index.vue:399\");\n                  }\n                });\n              },\n              fail: function fail(res) {\n                __f__(\"log\", \"connectSocket fail\", res, \" at pages/index/index.vue:405\");\n              }\n            });\n          },\n          fail: function fail(res) {\n            __f__(\"log\", \"closeSocket\", res, \" at pages/index/index.vue:411\");\n            uni.connectSocket({\n              url: that.WSSUrl,\n              success: function success(res) {\n                that.tipsPoint = true;\n                __f__(\"log\", \"connectSocket\", res, \" at pages/index/index.vue:416\");\n                uni.setStorage({\n                  key: 'WSSURL',\n                  data: that.WSSUrl,\n                  success: function success(res) {\n                    __f__(\"log\", 'success', res, \" at pages/index/index.vue:421\");\n                  },\n                  fail: function fail() {\n                    __f__(\"log\", 'fail', res, \" at pages/index/index.vue:424\");\n                  }\n                });\n              },\n              fail: function fail(res) {\n                __f__(\"log\", \"connectSocket fail\", res, \" at pages/index/index.vue:430\");\n              }\n            });\n          }\n        });\n        that.clickHidePopupWSS();\n      } else {\n        uni.showToast({\n          icon: 'error',\n          title: 'Url  Is  Empty！'\n        });\n      }\n    },\n    languageSwitch: function languageSwitch(e) {\n      __f__(\"log\", e.detail.value, \" at pages/index/index.vue:446\");\n      if (e.detail.value) {\n        this.language = e.detail.value;\n        // this.langugeType='recognition';\n        this.langugeType = 'en-US';\n      } else if (!e.detail.value) {\n        this.language = e.detail.value;\n        // this.langugeType='recognitionCN';\n        this.langugeType = 'zh-CN';\n      }\n    },\n    clickShowPopup: function clickShowPopup() {\n      // console.log(\"clickShowPopup\")\n      this.$refs.popup.open();\n    },\n    clickHidePopup: function clickHidePopup() {\n      // console.log(\"clickHidePopup\")\n      this.$refs.popup.close();\n    },\n    clickLinkServices: function clickLinkServices() {\n      // console.log(\"clickLinkServices\");\n      this.clickHidePopup();\n      this.sendSocketMessage(JSON.stringify({\n        close: 'close'\n      }));\n      this.sendSocketMessage(JSON.stringify({\n        sence: '4'\n      }));\n    },\n    clickPlayVideo: function clickPlayVideo(e) {\n      // console.log(e.currentTarget.dataset.index);\n      this.clickHidePopup();\n      this.sendSocketMessage(JSON.stringify({\n        close: 'close'\n      }));\n      this.sendSocketMessage(JSON.stringify({\n        sence: e.currentTarget.dataset.index\n      }));\n    },\n    clickPlayAudio: function clickPlayAudio(e) {\n      // console.log(e.currentTarget.dataset.index);\n      this.clickHidePopup();\n      this.sendSocketMessage(JSON.stringify({\n        close: 'close'\n      }));\n      this.sendSocketMessage(JSON.stringify({\n        audio: e.currentTarget.dataset.index\n      }));\n    },\n    langTap: function langTap() {\n      var that = this;\n      if (!that.tipsPoint) {\n        uni.showToast({\n          icon: 'error',\n          title: \"WS offline\"\n        });\n        return false;\n      }\n      clearTimeout(langtaptimeout);\n      var langtaptimeout = setTimeout(function () {\n        __f__(\"log\", 'langTap', \" at pages/index/index.vue:494\");\n        // this.recorder.start();\n        that.recorder.start(that.options);\n        that.showUserPart = false;\n        that.showRobotPart = false;\n        that.isLangTap = true;\n        that.isThinking = false;\n        that.userMsg = '';\n        that.robotMsg = '';\n        that.robotMsgList = [];\n        that.recording = true;\n        that.recordStatus = 2;\n        that.sendSocketMessage(JSON.stringify({\n          close: 'close'\n        }));\n        that.sendSocketMessage(JSON.stringify({\n          sence: '3'\n        }));\n      }, 200);\n    },\n    touchStart: function touchStart(e) {\n      var that = this;\n\n      // that.clientX = e.changedTouches[0].clientX; //手指按下时的X坐标\n      // that.clientY = e.changedTouches[0].clientY; //手指按下时的Y坐标\n      // if(that.isLangTap){\n      // navigator.getUserMedia({\n      // \taudio: true\n      // }, function(stream) {\n      // \tthat.recorder = new HZRecorder(stream)\n      // \tconsole.log('初始化完成');\n      // }, function(e) {\n      // \tconsole.log('No live audio input: ' + e);\n      // });\n      // }\n    },\n    touchMove: function touchMove(e) {\n      var touchData = e.touches[0];\n      var moveX = touchData.clientX - this.clientX;\n      var moveY = touchData.clientY - this.clientY;\n      if (moveY < -50) {\n        // 向上滑动\n        this.cancelRecord = true;\n        this.recordStatus = 1;\n        // console.log(\"向上滑动\");\n      } else {\n        // 向下滑动\n        this.cancelRecord = false;\n        this.recordStatus = 2;\n        // console.log(\"向下滑动\");\n      }\n    },\n    touchEnd: function touchEnd() {\n      var that = this;\n      if (!that.cancelRecord && that.isLangTap == true) {\n        // 完成录音\n        that.recorder.stop();\n        that.showUserPart = true;\n        that.isAsring = false;\n        __f__(\"info\", '进来了？？？', \" at pages/index/index.vue:550\");\n        that.isLangTap = false;\n      } else {\n        // 此时松手后响应的是取消录音\n        __f__(\"info\", '取消录音', \" at pages/index/index.vue:554\");\n      }\n      that.recordStatus = 0;\n      that.recording = false;\n      that.cancelRecord = false;\n      // that.isLangTap = false;\n    },\n    playVoice: function playVoice() {\n      __f__(\"log\", '播放录音', \" at pages/index/index.vue:565\");\n      if (this.voicePath) {\n        this.innerAudioContext.src = this.voicePath;\n        this.innerAudioContext.play();\n      }\n    },\n    sendSocketMessage: function sendSocketMessage(msg) {\n      var that = this;\n      if (that.socketOpen) {\n        uni.sendSocketMessage({\n          data: msg\n        });\n      } else {\n        __f__(\"log\", \"error\", msg, \" at pages/index/index.vue:579\");\n      }\n    }\n  }\n};\nexports.default = _default;\n/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/vue-cli-plugin-uni/lib/format-log.js */ 1)[\"default\"]))//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///41\n");
